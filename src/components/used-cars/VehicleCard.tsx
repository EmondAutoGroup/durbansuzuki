...
export default function VehicleCard({ vehicle }: VehicleCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        <h3 className="font-bold text-text-primary line-clamp-1 group-hover:text-suzuki-blue transition-colors duration-300">
          {vehicle.fullTitle}
        </h3>
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
          <p className="text-suzuki-red font-extrabold text-xl">{formatPrice(vehicle.priceIncl)}</p>
          <span className="text-xs text-text-muted group-hover:text-suzuki-blue transition-colors flex items-center gap-1">
            Details
