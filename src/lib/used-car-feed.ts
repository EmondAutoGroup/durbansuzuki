...
import { UsedVehicle, VehicleImage } from './types';

const FEED_URL = process.env.USED_CAR_FEED_URL!;
...
function parseVehicle(raw: Record<string, unknown>): UsedVehicle {
...
export async function getUsedVehicleByStock(stockNumber: string): Promise<UsedVehicle | undefined> {
